...
public class LayoutManagerSmoothScroller extends LinearLayoutManager {
    ...
    @Override
    public void smoothScrollToPosition(RecyclerView recyclerView, HiveRecyclerView.State state, int position) {
        HiveRecyclerView.SmoothScroller smoothScroller = new TopSnappedSmoothScroller(recyclerView.getContext());
