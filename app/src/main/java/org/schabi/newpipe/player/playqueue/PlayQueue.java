...
import static org.schabi.newpipe.player.MainVideoPlayer.qualityChangedIndex;
    ...
    private Subscriber<PlayQueueEvent> getSelfReporter() {
        return new Subscriber<PlayQueueEvent>() {
            ...
            public void onNext(PlayQueueEvent event) {
                Log.i("PlayQueue","===========onNext()");
                Log.d(TAG, "Received broadcast: " + event.type().name() + ". Current index: " + getIndex() + ", play queue length: " + size() + ".");
                Log.i("PlayQueue","=qualityChangedIndex is "+qualityChangedIndex);
//                if (playStart || playNext || playPrevious || localPlayAll || subscribePlayAll || statisticPlayAll
//                       || listPlayAll || routerPlayAll || qualityChangedIndex == 0){
//                    Log.i("PlayQueue","=================playStart or playNext is true");
//                    playStart = false;
//                    playNext = false;
//                    playPrevious = false ;
//                    localPlayAll = false;
//                    subscribePlayAll = false;
//                    statisticPlayAll = false;;
//                    listPlayAll = false;
//                    routerPlayAll = false;
////                    qualityChangedIndex = -1;
//                }else {
//                    Toast.makeText(App.getInstance(), R.string.play_auto_next, Toast.LENGTH_SHORT).show();
//                }
