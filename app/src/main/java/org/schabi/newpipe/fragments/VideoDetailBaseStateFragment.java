...
import static org.schabi.newpipe.fragments.detail.VideoDetailFragment.play_start;
import static org.schabi.newpipe.util.AnimationUtils.animateView;

public abstract class VideoDetailBaseStateFragment<I> extends BaseFragment implements ViewContract<I> {
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        errorButtonRetry.setOnKeyListener(onKeyListener);
