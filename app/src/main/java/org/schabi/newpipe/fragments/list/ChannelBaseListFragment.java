...
public abstract class ChannelBaseListFragment<I, N> extends BaseStateFragment<I> implements ListViewContract<I, N>, StateSaver.WriteRead {
    ...
    protected HiveRecyclerView itemsList;
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        LinearLayoutManager msfeed= new LinearLayoutManager(activity);
        msfeed.setOrientation(LinearLayoutManager.HORIZONTAL);
        itemsList.setLayoutManager(msfeed);//getListLayoutManager()
