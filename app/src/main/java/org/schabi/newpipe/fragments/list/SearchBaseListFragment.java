...
import org.schabi.newpipe.fragments.FindBaseStateFragment;
import org.schabi.newpipe.fragments.OnScrollBelowItemsListener;
import org.schabi.newpipe.info_list.SearchInfoListAdapter;
...
import org.schabi.newpipe.views.HiveRecyclerViewFind;
...
public abstract class SearchBaseListFragment<I, N> extends FindBaseStateFragment<I> implements ListViewContract<I, N>, StateSaver.WriteRead {

    /*//////////////////////////////////////////////////////////////////////////
    // Views
    //////////////////////////////////////////////////////////////////////////*/

    protected SearchInfoListAdapter infoListAdapter;
    protected HiveRecyclerViewFind itemsList;
    ...
    public void onAttach(Context context) {
        ...
        infoListAdapter = new SearchInfoListAdapter(activity);
    }
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        GridLayoutManager mLayoutManager=new GridLayoutManager(activity,4,GridLayoutManager.VERTICAL,false);//设置为一个4列的纵向网格布局
        /*mLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            @Override
            public int getSpanSize(int position) {
                if(infoListAdapter.getItemViewType(position)==1){// getItemViewType
