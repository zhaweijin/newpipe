...
import org.schabi.newpipe.fragments.list.ChannelBaseListInfoFragment;
...
import org.schabi.newpipe.views.ChannelHiveRecyclerView;
...
public class ChannelFragment extends ChannelBaseListInfoFragment<ChannelInfo> implements View.OnFocusChangeListener {
    ...
    private Button headerSubscribeButton, channelPlayAll;
...
//    private LinearLayout headerBackgroundButton;
    ...
    public static boolean subscribePlayAll = false;
    public static boolean channelOnePlayAll = false;
...
//        headerRootLayout = activity.getLayoutInflater().inflate(R.layout.channel_header_one, itemsList, false);
...
//        playlistCtrl = headerRootLayout.findViewById(R.id.playlist_control);
        channelPlayAll = rootView.findViewById(R.id.play_all);
        channelBackground = rootView.findViewById(R.id.channel_background);
        headerSubscribeButton.setVisibility(View.VISIBLE);
        headerSubscribeButton.setFocusable(true);
        headerSubscribeButton.requestFocus();
//        headerSubscribeButton.setBackground(getResources().getDrawable(R.drawable.img_selector_btn));

        String title = currentInfo != null ? currentInfo.getName() : name;
        headerTitleView.setText(title);

        headerSubscribeButton.setOnFocusChangeListener(this);
        channelPlayAll.setOnFocusChangeListener(this);
...
//        }
        ...
        channelPlayAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getPlayQueue() != null) {
                    NavigationHelper.playOnMainPlayer(activity, getPlayQueue());
                    subscribePlayAll = true;
                    App.isAutoPlay = true;
                } else {
                    Toast.makeText(App.getInstance(), "正在加载数据中，请稍等", Toast.LENGTH_SHORT).show();
                }

            }
        });
        ((ChannelHiveRecyclerView) itemsList).setParent(this);
    }
...
//        playlistCtrl = headerRootLayout.findViewById(R.id.playlist_control);
        channelPlayAll = headerRootLayout.findViewById(R.id.play_all);
        channelBackground = headerRootLayout.findViewById(R.id.channel_background);
        headerSubscribeButton.setVisibility(View.VISIBLE);
        headerSubscribeButton.setFocusable(true);
        headerSubscribeButton.requestFocus();
//        headerSubscribeButton.setBackground(getResources().getDrawable(R.drawable.button_select));
...
//        channelPlayAll.setOnClickListener(
...
//            animateBackgroundColordColor(headerSubscribeButton, backgroundDuration, subscribedBackground, subscribeBackground);
...
//        imageLoader.cancelDisplayTask(headerChannelBanner);
        //////////////
//        imageLoader.cancelDisplayTask(channelBackground);
...
//        		ImageDisplayConstants.DISPLAY_BANNER_OPTIONS);
        ////////////////
//        imageLoader.displayImage(result.getBannerUrl(), channelBackground,
//                ImageDisplayConstants.DISPLAY_BANNER_OPTIONS);
...
//        headerTitleView.setText(title);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        switch (v.getId()) {
            case R.id.channel_subscribe_button:
//                headerSubscribeButton.setBackground(getResources().getDrawable(R.drawable.img_selector_btn));
                break;
            case R.id.play_all:
//                channelPlayAll.setBackground(getResources().getDrawable(R.drawable.img_selector_btn));
                break;
        }
    }
}
