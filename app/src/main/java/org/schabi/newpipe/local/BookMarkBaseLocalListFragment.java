...
import org.schabi.newpipe.fragments.BookMarkBaseStateFragment;
 ...
 * */
public abstract class BookMarkBaseLocalListFragment<I, N> extends BookMarkBaseStateFragment<I>
    ...
    protected LocalItemListAdapterNew itemListAdapter;
    public static HiveRecyclerView itemsList;
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        GridLayoutManager mLayoutManager=new GridLayoutManager(activity,4,GridLayoutManager.VERTICAL,false);//����Ϊһ��3�е��������񲼾�
        ...
        itemListAdapter = new LocalItemListAdapterNew(activity);
