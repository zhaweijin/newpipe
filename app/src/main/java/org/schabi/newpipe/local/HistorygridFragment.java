...
import org.schabi.newpipe.fragments.HistoryBaseStateFragment;
import org.schabi.newpipe.fragments.HistoryBaseStateFragment$$Icepick;
...
import org.schabi.newpipe.views.HiveRecyclerViewHistory;
 ...
 * */
public abstract class HistorygridFragment<I, N> extends HistoryBaseStateFragment<I>
    ...
    protected HistoryAdapter itemListAdapter;
    public static HiveRecyclerViewHistory itemsList;
    ...
    protected void initViews(View rootView, Bundle savedInstanceState) {
        ...
        mLayoutManager=new GridLayoutManager(activity,4,GridLayoutManager.VERTICAL,false);//设置为一个3列的纵向网格布局
        ...
        itemListAdapter = new HistoryAdapter(activity);
    ...
    public void showEmptyState() {
        ...
        StatisticsPlaylistFragment.deleteLocation=-1;
        showListFooter(false);
    }
