...
public class HistoryRecordManager {
    ...
    public Maybe<Long> onViewed(final StreamInfo info) {
        ...
        return Maybe.fromCallable(() -> database.runInTransaction(new Callable<Long>() {
            @Override
     ...
     * @return
     */
    public boolean checkStreamExistHistory(final StreamInfo info){
        return streamTable.checkExist(new StreamEntity(info));
    }
}
